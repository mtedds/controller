...
class Logic:
        ...
        self.logic_methods = {
            ...
            'Ensuite fan boost relay': [self.logic_fan_boost,
                                        ["Ensuite fan control relay",
                                         ...
                                         "Ensuite light switch",
                                         "Ensuite humidity"]],
            # Utility extractor fan control
            'Utility humidity': [self.u_logic_fan_boost,
    ...
    # TODO - Add the fan mains control to switch the fan fully off
    # Will need to add a mains relay to the Ensuite node and replace with this code
    def u_logic_fan_boost(self, in_sensor, in_sensor_id, in_sensor_name, in_sensor_value, in_arguments):
